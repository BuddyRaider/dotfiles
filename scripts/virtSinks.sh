...
function getIDs () {
	pactl list modules short | grep module-null-sink | grep media.name=VirtSink | awk '{print $1}'
}
...
if [[ "$1" == "rm" ]]; then
	...
	pactl load-module module-null-sink media.name=VirtSink sink_name="$1"
fi

if [[ -n "$2" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$2"
fi

if [[ -n "$3" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$3"
fi

if [[ -n "$4" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$4"
fi

if [[ -n "$5" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$5"
fi

if [[ -n "$6" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$6"
fi

if [[ -n "$7" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$7"
fi

if [[ -n "$8" ]]; then
	pactl load-module module-null-sink media.name=VirtSink sink_name="$8"
fi
